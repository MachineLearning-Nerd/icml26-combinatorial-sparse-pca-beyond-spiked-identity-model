...
All Model-2 assumptions pass. The independent checker passes. Five
claim-specific tamper controls are rejected, including a certificate with its
rare-event mass changed to `1/2`.
